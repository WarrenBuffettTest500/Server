...
router.get('/:user_id/preference-infos/:preference_info_id', verifyToken, getPreferenceInfo);
router.post('/:user_id/preference-infos', verifyToken, createPreferenceInfo);
router.put('/:user_id/preference-infos', verifyToken, updatePreferenceInfo);

router.get('/:user_id/portfolio', verifyToken, getPortfolio);
router.post('/:user_id/portfolio-items', verifyToken, createPortfolioItem);
router.put('/:user_id/portfolio-items/:portfolio_item_id', verifyToken, updatePortfolioItem);
router.delete('/:user_id/portfolio-items/:portfolio_item_id', verifyToken, deletePortfolioItem);
